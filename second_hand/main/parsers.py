...
#         soup = BS(req.content, 'lxml')
#         #all_shop = soup.find(class_='shops__list not-list')
#         all_shop1 = soup.find_all('a', class_='shops__link')
#         dict_shop = dict()
#         for i in all_shop1:
#             if i.text == '\n':
#                 continue
...
#         return dict_shop_data
#
# req = requests.get(Adzenne.url, headers=Adzenne.headers)
# soup = BS(req.content, 'lxml')
# #print(soup)
# all_shop1 = soup.find_all(class_='wpb_column vc_column_container vc_col-sm-2 vc_hidden-md vc_hidden-sm vc_hidden-xs')
# for i in all_shop1:
#     #a = 'https://second-hand.by/kramy/' + i.get('href')
#     print(i)
class Megahand:
    pass
